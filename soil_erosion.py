...
from soil_erosion_dockwidget import SoilErosionDockWidget
import os.path
...
class SoilErosion:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('SoilErosion', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/SoilErosion/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Soil Erosion Plugin'),
            callback=self.run,
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = SoilErosionDockWidget()
